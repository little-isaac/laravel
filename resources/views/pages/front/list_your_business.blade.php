            ...
            <form action='{{ URL::to('/list-your-business') }}' method='post'>
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="form-group @if($errors->has('business_name')) has-error has-feedback  @endif">
                            <label> Business Name:</label>
                            <input type="text" class="form-control" required placeholder="Enter Business Name" name='business_name'/>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group @if($errors->has('business_phone')) has-error has-feedback  @endif">
                            <label>Business Phone:  <span class="error hide">Please enter a valid number</span></label>
                            <input  required type="number" class="form-control number" placeholder="Enter "  name='business_phone'>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group @if($errors->has('business_email')) has-error has-feedback  @endif">
                            <label for="pwd">Business Email:</label>
                            <input required type="email" class="form-control"  name='business_email'  placeholder="Enter Business Email">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group @if($errors->has('zipcode')) has-error has-feedback  @endif">
                            <label>Business Zipcode:</label>
                            <input required type="number" class="form-control" id="conf_pwd" name='zipcode'  placeholder="Enter Business Zipcode">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group @if($errors->has('email')) has-error has-feedback  @endif">
                            ...
                            <input required type="email" class="form-control" placeholder="Enter Customer Email" name='email'/>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group @if($errors->has('contact_no')) has-error has-feedback  @endif">
                            <label>Contact Number:</label>
                            <input required type="text" class="form-control" placeholder="Enter Contact number" name='contact_no'/>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group @if($errors->has('category')) has-error has-feedback  @endif">
                            ...
                            <select required class="form-control select" name="category">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group @if($errors->has('no_of_physical_locations')) has-error has-feedback  @endif">
                            <label>Number of physical location:</label>
                            <div class="radio">
                                <label>
                                    <input required type="radio"  value="1-5" name='no_of_physical_locations'/>1 to 5
                                </label>
                                <label>
                                    <input required type="radio"  value="More than 5" name='no_of_physical_locations'/>More than 5
                                </label>
